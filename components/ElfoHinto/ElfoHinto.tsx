      ...
      >
        ...
        <g id="braccio_x5F_six_x5F_1">
          ...
          <path
            id="mano_six_4_"
            fill="#F8CEDE"
            d="M233.6 318.5h9.6s3.5 11.2 1.2 11.2-3.5-5.6-3.5-5.6.8 8.9-1.6 8.7c-2.4-.2-2.4-8.2-2.4-8.2s-.6 5.1-3.4 4.8.1-10.9.1-10.9z"
          />
        </g>
        ...
        <g id="orecchio_dex">
          <path
            fill="#F8CEDE"
            d="M207.4 181.4s2.4-26.8 12.3-40 15.3-17.6 17.3-18.9c0 0 2.7 18.3-9.3 37.2s-20.3 21.7-20.3 21.7z"
          />
          <path
            fill="none"
            stroke="#DE8BB5"
        ...
        <g id="orecchio_dex_1_">
          <path
            fill="#F8CEDE"
            d="M75.6 129.6S88.2 134 97.5 151s9.3 16.6 12.6 28.1c0 0-19.1-9.4-27.2-24.8s-7.3-24.7-7.3-24.7z"
          />
          <path
            fill="none"
            stroke="#DE8BB5"
